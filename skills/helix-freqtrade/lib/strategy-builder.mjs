...
//
// 用 indicators[] + 可选的 entry_logic / exit_logic 拼出一份 freqtrade
// IStrategy 子类 .py 文件文本. 这里只生成技术指标策略, 不注入外部市场
// 情报数据源.
//
...
export function buildStrategyCode(name, tf, desc, indicators, entryLogic, exitLogic, direction = 'long') {
  const L = [];  // lines
